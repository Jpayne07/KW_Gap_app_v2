...
function ProjectItem(){
  ...
  if (!project) {
    ...
    return(<div><ProjectItemComponent singularProject = {project} collaborationsFromParent =  {userCollaborations} setCollaborations = {setUserCollaborations}/></div>)
}
